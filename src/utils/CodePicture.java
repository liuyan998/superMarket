...
public class CodePicture {
    ...
    // 字体大小
    private static final int FONT_SIZE = 20;//30
     ...
     * @return 返回验证码字符串
     */
    public static String getPicture(JLabel label) {
        Object[] obj = CodePicture.createImage();
        String yzm = obj[0].toString();
        System.out.println("1:" + yzm);
    ...
    public static void main(String[] args) throws IOException {
        ...
        OutputStream os =
                new FileOutputStream("images/yanzhengma.png");
